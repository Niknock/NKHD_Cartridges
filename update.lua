...
Citizen.CreateThread( function()
    PerformHttpRequest("https://raw.githubusercontent.com/Niknock/NKHD_Cartridges/main/version", checkVersion, "GET")
end)